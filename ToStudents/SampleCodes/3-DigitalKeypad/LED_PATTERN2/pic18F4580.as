...
glow_on_press@key:	; 1 bytes @ 0x3
	ds   1
	global	glow_on_press@wait
glow_on_press@wait:	; 2 bytes @ 0x4
	ds   2
	global	glow_on_press@wait1
glow_on_press@wait1:	; 2 bytes @ 0x6
	ds   2
...
l803:
;main.c: 89: unsigned char key;
;main.c: 90: unsigned int i, k, l;
;main.c: 91: unsigned int wait;
;main.c: 92: unsigned int wait1;
;main.c: 93: unsigned int j;
;main.c: 94: init_config();
...
l73:
	line	99
;main.c: 97: {
;main.c: 99: key = read_digital_keypad(1);
	movlw	(01h)&0ffh
...
l805:
;main.c: 101: if (key == 0x0E || key == 0x0D || key == 0x0B || key == 0x07)
		movlw	14
...
l799:
;main.c: 79: ADCON1 = 0x0F;
	movlw	low(0Fh)
	movwf	((c:4033)),c	;volatile
	line	81
;main.c: 81: PORTB = 0x00;
	movlw	low(0)
	movwf	((c:3969)),c	;volatile
	line	82
;main.c: 82: TRISB = 0x00;
	movlw	low(0)
	movwf	((c:3987)),c	;volatile
	line	84
	
l801:
;main.c: 84: init_digital_keypad();
...
l709:
;main.c: 20: {
;main.c: 21: PORTB = 0x00;
	movlw	low(0)
	movwf	((c:3969)),c	;volatile
	line	23
;main.c: 23: for(i = 0; i < 8; i++)
	movlw	high(0)
...
u204:
	...
	goto	u205
	movf	(??_glow_on_press+1+0),c,w
	andwf	((c:3969)),c,w	;volatile
	movwf	((c:3969)),c	;volatile
	line	53
	
l763:
;main.c: 53: for (wait = 500; wait--;)
	movlw	high(01F4h)
	movwf	((c:glow_on_press@wait+1)),c
	movlw	low(01F4h)
	movwf	((c:glow_on_press@wait)),c
...
l777:
;main.c: 59: {
;main.c: 60: PORTB = 0xFF;
	setf	((c:3969)),c	;volatile
	line	62
	
l779:
;main.c: 62: for (i = 0; i < 8; i++)
	movlw	high(0)
	movwf	((c:glow_on_press@i+1)),c
	movlw	low(0)
	movwf	((c:glow_on_press@i)),c
