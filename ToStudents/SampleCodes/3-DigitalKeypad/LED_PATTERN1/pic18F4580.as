...
read_digital_keypad@detection_type:	; 1 bytes @ 0x0
	ds   3
	global	glow_on_press@wait
glow_on_press@wait:	; 2 bytes @ 0x3
	ds   2
	global	glow_on_press@wait1
glow_on_press@wait1:	; 2 bytes @ 0x5
	ds   2
	global	glow_on_press@key
glow_on_press@key:	; 1 bytes @ 0x7
	ds   1
	global	glow_on_press@i
glow_on_press@i:	; 2 bytes @ 0x8
	ds   2
??_main:	; 1 bytes @ 0xA
	ds   2
	global	main@i
...
main@wait:	; 2 bytes @ 0xE
	ds   2
	global	main@wait1
main@wait1:	; 2 bytes @ 0x10
	ds   2
	global	main@key
main@key:	; 1 bytes @ 0x12
	ds   1
	global	main@j
main@j:	; 2 bytes @ 0x13
	ds   2
...
;;  j               2   19[COMRAM] unsigned int 
;;  wait1           2   16[COMRAM] unsigned int 
;;  wait            2   14[COMRAM] unsigned int 
;;  i               2   12[COMRAM] unsigned int 
;;  key             1   18[COMRAM] unsigned char 
...
l744:
;main.c: 63: unsigned char key;
;main.c: 64: unsigned int i;
;main.c: 65: unsigned int wait;
;main.c: 66: unsigned int wait1;
;main.c: 67: unsigned int j;
;main.c: 68: init_config();
	call	_init_config	;wreg free
	line	69
	
l746:
;main.c: 69: PORTB = 0x01;
	movlw	low(01h)
...
l752:
;main.c: 76: for(wait1 = 500; wait1--; );
	movlw	high(01F4h)
	movwf	((c:main@wait1+1)),c
	movlw	low(01F4h)
	movwf	((c:main@wait1)),c
	goto	l754
...
l754:
	decf	((c:main@wait1)),c
	btfss	status,0
	decf	((c:main@wait1+1)),c
		incf	((c:main@wait1)),c,w
	bnz	u191
	incf	((c:main@wait1+1)),c,w
	btfss	status,2
	goto	u191
	goto	u190
...
l760:
;main.c: 78: key = read_digital_keypad(1);
	movlw	(01h)&0ffh
...
l740:
;main.c: 53: ADCON1 = 0x0F;
	movlw	low(0Fh)
	movwf	((c:4033)),c	;volatile
	line	55
;main.c: 55: PORTB = 0x00;
	movlw	low(0)
	movwf	((c:3969)),c	;volatile
	line	56
;main.c: 56: TRISB = 0x00;
	movlw	low(0)
	movwf	((c:3987)),c	;volatile
	line	58
	
l742:
;main.c: 58: init_digital_keypad();
...
l696:
;main.c: 6: unsigned int i;
;main.c: 7: unsigned int wait;
;main.c: 8: unsigned int wait1;
;main.c: 18: if (key == 0x0E)
		movlw	14
...
l698:
;main.c: 19: {
;main.c: 20: PORTB = 0x00;
	movlw	low(0)
	movwf	((c:3969)),c	;volatile
	line	22
;main.c: 22: for(i = 0; i < 8; i++)
	movlw	high(0)
	movwf	((c:glow_on_press@i+1)),c
	movlw	low(0)
	movwf	((c:glow_on_press@i)),c
	
l700:
		movf	((c:glow_on_press@i+1)),c,w
	bnz	u70
	movlw	8
	subwf	 ((c:glow_on_press@i)),c,w
	btfss	status,0
	goto	u71
	goto	u70
...
l704:
;main.c: 23: {
;main.c: 24: PORTB = PORTB | 0x80 >> i;
	movff	(c:glow_on_press@i),??_glow_on_press+0+0
	movlw	low(080h)
	movwf	(??_glow_on_press+1+0)&0ffh,c
	movlw	high(080h)
	movwf	1+(??_glow_on_press+1+0)&0ffh,c
	incf	(??_glow_on_press+0+0),c
	goto	u84
u85:
	rlcf	(??_glow_on_press+1+1),c,w
	rrcf	(??_glow_on_press+1+1),c
	rrcf	(??_glow_on_press+1+0),c
u84:
	decfsz	(??_glow_on_press+0+0),c
	goto	u85
	movf	(??_glow_on_press+1+0),c,w
	iorwf	((c:3969)),c,w	;volatile
	movwf	((c:3969)),c	;volatile
	line	26
	
l706:
;main.c: 26: for(wait = 500; wait--; )
	movlw	high(01F4h)
	movwf	((c:glow_on_press@wait+1)),c
	movlw	low(01F4h)
	movwf	((c:glow_on_press@wait)),c
	goto	l712
	line	27
...
l708:
;main.c: 27: for(wait1 = 500; wait1--; );
	movlw	high(01F4h)
	movwf	((c:glow_on_press@wait1+1)),c
	movlw	low(01F4h)
	movwf	((c:glow_on_press@wait1)),c
	goto	l710
...
l710:
	decf	((c:glow_on_press@wait1)),c
	btfss	status,0
	decf	((c:glow_on_press@wait1+1)),c
		incf	((c:glow_on_press@wait1)),c,w
	bnz	u91
	incf	((c:glow_on_press@wait1+1)),c,w
	btfss	status,2
	goto	u91
	goto	u90
...
l712:
	decf	((c:glow_on_press@wait)),c
	btfss	status,0
	decf	((c:glow_on_press@wait+1)),c
		incf	((c:glow_on_press@wait)),c,w
	bnz	u101
	incf	((c:glow_on_press@wait+1)),c,w
	btfss	status,2
	goto	u101
	goto	u100
...
l714:
	infsnz	((c:glow_on_press@i)),c
	incf	((c:glow_on_press@i+1)),c
