...
l736:
;main.c: 17: {
;main.c: 20: ssd[0] = 0xE7;
	movlw	low(0E7h)
	movwf	((c:_ssd)),c
	line	21
	
l738:
;main.c: 21: display(ssd);
		movlw	low(_ssd)
...
l744:
;main.c: 24: ssd[0] = 0xCB;
	movlw	low(0CBh)
	movwf	((c:_ssd)),c
	line	25
	
l746:
;main.c: 25: display(ssd);
		movlw	low(_ssd)
	movwf	((c:display@data)),c
	movlw	high(_ssd)
	movwf	((c:display@data+1)),c
...
l752:
;main.c: 28: ssd[0] = 0x2D;
	movlw	low(02Dh)
	movwf	((c:_ssd)),c
	line	29
	
l754:
;main.c: 29: display(ssd);
		movlw	low(_ssd)
	movwf	((c:display@data)),c
	movlw	high(_ssd)
	movwf	((c:display@data+1)),c
...
l756:
;main.c: 30: ssd[0] = 0x6E;
	movlw	low(06Eh)
	movwf	((c:_ssd)),c
	line	31
	
l758:
;main.c: 31: display(ssd);
		movlw	low(_ssd)
	movwf	((c:display@data)),c
	movlw	high(_ssd)
	movwf	((c:display@data+1)),c
...
l760:
;main.c: 32: ssd[0] = 0xEE;
	movlw	low(0EEh)
	movwf	((c:_ssd)),c
	line	33
	
l762:
;main.c: 33: display(ssd);
		movlw	low(_ssd)
	movwf	((c:display@data)),c
	movlw	high(_ssd)
	movwf	((c:display@data+1)),c
...
l764:
;main.c: 34: ssd[0] = 0x23;
	movlw	low(023h)
	movwf	((c:_ssd)),c
	line	35
	
l766:
;main.c: 35: display(ssd);
		movlw	low(_ssd)
	movwf	((c:display@data)),c
	movlw	high(_ssd)
	movwf	((c:display@data+1)),c
...
l768:
;main.c: 36: ssd[0] = 0xEF;
	movlw	low(0EFh)
	movwf	((c:_ssd)),c
	line	37
	
l770:
;main.c: 37: display(ssd);
		movlw	low(_ssd)
	movwf	((c:display@data)),c
	movlw	high(_ssd)
	movwf	((c:display@data+1)),c
...
l772:
;main.c: 38: ssd[0] = 0x6F;
	movlw	low(06Fh)
	movwf	((c:_ssd)),c
	line	40
	
l774:
;main.c: 40: display(ssd);
		movlw	low(_ssd)
	movwf	((c:display@data)),c
	movlw	high(_ssd)
	movwf	((c:display@data+1)),c
...
;;  digit           1    6[COMRAM] unsigned char 
...
l716:
;ssd_display.c: 19: unsigned int wait;
;ssd_display.c: 20: unsigned char data_bit;
;ssd_display.c: 21: unsigned char digit;
;ssd_display.c: 23: for (digit = 0; digit < 4; digit++)
	movlw	low(0)
...
l722:
;ssd_display.c: 24: {
;ssd_display.c: 25: PORTD = data[digit];
...
l724:
;ssd_display.c: 26: PORTA = (PORTA & 0xF0) | (0x01 << digit);
...
l726:
;ssd_display.c: 28: for (wait = 60000; wait--; );
	movlw	high(0EA60h)
