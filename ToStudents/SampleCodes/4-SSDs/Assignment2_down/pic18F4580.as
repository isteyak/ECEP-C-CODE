...
l766:
;main.c: 14: unsigned int wait;
;main.c: 15: init_config();
	call	_init_config	;wreg free
	line	16
	
l768:
;main.c: 16: int A[10] = {0xE7, 0x21, 0xCB, 0x6B, 0x2D, 0x6E, 0xEE, 0x23, 0xEF, 0x6F};
	lfsr	2,(main@F15930)
	lfsr	1,(main@A)
	movlw	20-1
u181:
...
;ssd_display.c: 20: unsigned int wait1;
;ssd_display.c: 21: unsigned char data_bit;
;ssd_display.c: 22: unsigned char digit;
;ssd_display.c: 23: int i;
;ssd_display.c: 25: for (i = 0; i < 50; i++)
	movlw	high(0)
...
l744:
;ssd_display.c: 26: {
;ssd_display.c: 27: for (digit = 0; digit < 4; digit++)
	movlw	low(0)
...
l750:
;ssd_display.c: 28: {
;ssd_display.c: 29: PORTD = data[digit];
...
l752:
;ssd_display.c: 30: PORTA = (PORTA & 0xF0) | (0x01 << digit);
...
l754:
;ssd_display.c: 32: for (wait = 1000; wait--; );
	movlw	high(03E8h)
