...
//	printf("15. append list\n");
	...
	printf("17. merge 2 links in sorted order\n");	
	printf("18. Reverse the list\n");	
	printf("19. Length of the list\n");	
...
/*	    case 15: 
		...
		break;*/
		case 15:
		printf("Enter the val to search in node : ");
		scanf("%d", &val);
		result = find_node(head, val);
		if (result == EMPTYLIST)
		{
		    printf("List is empty\n");
		    break;
		}
		(result == FAILURE)? printf("find_node FAILURE.\n"): printf("node of list is: %d\n", result);
