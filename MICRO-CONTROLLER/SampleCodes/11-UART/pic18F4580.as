...
;!
;!    puts@s	PTR const unsigned char  size(2) Largest target is 62
...
l775:
;main.c: 15: char c;
;main.c: 17: init_config();
	call	_init_config	;wreg free
	line	19
;main.c: 19: puts("Welcome. This is UART Test Code.\n\r");
		movlw	low(STR_2)
	movwf	((c:puts@s)),c
	movlw	high(STR_2)
	movwf	((c:puts@s+1)),c
	...
	line	20
;main.c: 20: puts("You should get back whatever you type:\n\r");
		movlw	low(STR_3)
	movwf	((c:puts@s)),c
	movlw	high(STR_3)
	movwf	((c:puts@s+1)),c
...
l771:
;main.c: 9: puts("Emertxe Information Technologies. Press any key to continue\n\r");
		movlw	low(STR_1)
	movwf	((c:puts@s)),c
	movlw	high(STR_1)
	movwf	((c:puts@s+1)),c
...
;; *************** function _getche *****************
;; Defined at:
;;		line 112 in file "uart.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;  c               1    1[COMRAM] unsigned char 
;; Return value:  Size  Location     Type
...
l753:
;uart.c: 114: unsigned char c;
;uart.c: 116: putch(c = getch());
	call	_getch	;wreg free
	movwf	((c:getche@c)),c
	movf	((c:getche@c)),c,w
...
l755:
	line	119
;uart.c: 118: return (c);
;	Return value of _getche is never used
