...
Status decode_secret_file_size(FILE * fptr_stego_image, long *size_secret_file)
{
    ...
    fseek(fptr_stego_image, 63L, SEEK_SET);
...
Status decode_secret_magic_string(FILE * fptr_secret, FILE * fptr_stego_image)
{
